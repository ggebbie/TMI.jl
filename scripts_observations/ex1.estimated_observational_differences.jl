...
est_dict_modern, sample_dict_modern = estimate_global_mean_from_surface(Alu, TMIversion; 
														  N = N, iters = iters, Δθ = Δθ, σ = 0.3)

TMIversion = "LGM_90x45x33_G14";
A, Alu, γ, TMIfile, L, B = config_from_nc(TMIversion);

est_dict_LGM, sample_dict_LGM = estimate_global_mean_from_surface(Alu, TMIversion; 
														  N = N, iters = iters, Δθ = Δθ; σ = 0.3)
